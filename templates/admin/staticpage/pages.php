				...
				<table class = "table">
					...
					<?foreach($result as $key => $row):?>
						<tr>
							...
							<td><a href = "/admin/staticpage/edit.php?id=<?=$row['id']?>"><span class="glyphicon glyphicon-pencil"></span></a> / <a href = "javascript:void(0);" onclick = "deletePage('<?=$row['id']?>')"><span class = "glyphicon glyphicon-remove"></span></a></td>
							<?if($item == 1):?>
