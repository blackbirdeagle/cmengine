<form method = "POST" action = "">
	<input class = "form-control text" type = "text" name = "PAGE_TITLE" placeholder = "Заголовок окна браузера" required/>
	...
	<input class = "form-control translit_text" type = "text" name = "PAGE_KEY" placeholder = "Seo-ключ" required/>
