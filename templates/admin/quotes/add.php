	...
	<div class = "row">
		...
		<div class = "col-md-9"><?=$error?>
			<div class = "breadcrumbs">
				<a href = "/admin/">Главная</a> / <a href = "/admin/quotes/">Цитаты</a> / <span>Добавление цитаты</span> 
			</div>
			<?php require_once($_SERVER["DOCUMENT_ROOT"]."/templates/admin/blocks/forms/addquote.php");?>
		</div>
	</div>
</div>	
