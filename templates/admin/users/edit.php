	...
	<div class = "row">
		...
		<div class = "col-md-9">
			<div class = "breadcrumbs">
				<a href = "/admin/">Главная</a> / <a href = "/admin/users/">Пользователи</a> / <span><?=$userGet["name"]?></span>
			</div>
			<?php require_once($_SERVER["DOCUMENT_ROOT"]."/templates/admin/blocks/forms/edituser.php");?>
		</div>
	</div>
</div>	
